...
class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) => UserModel(
        ...
        datebirth:
            DateFormat("dd-MM-yyyy").format(DateTime.parse(json['datebirth'])),
        address: json['address'],
        country: json['country'],
        city: json['city'],
        postalcode: json['cp'],
        hardskills: (json['hardskills'] as List)
            .map((e) => hardskillFromJson(e))
            .toList(),
        educations: (json['educations'] as List)
            .map((e) => educationFromJson(e))
            .toList(),
        experiences: (json['experiences'] as List)
            .map((e) => experienceFromJson(e))
            .toList(),
        softskills: (json['softskills'] as List)
            .map((e) => softskillFromJson(e))
            .toList(),
        languages: (json['languages'] as List)
            .map((e) => languageFromJson(e))
            .toList(),
        certificates: (json['certificates'] as List)
            .map((e) => certificateFromJson(e))
            .toList(),
      );
}

Hardskill hardskillFromJson(Map<String, dynamic> json) =>
    Hardskill.fromJson(json);
...
Education educationFromJson(Map<String, dynamic> json) =>
...
class Education {
  ...
  Education(
      {this.educationid, this.academicname, this.academictitle, this.year});
...
Experience experienceFromJson(Map<String, dynamic> json) =>
...
Softskill softskillFromJson(Map<String, dynamic> json) =>
    Softskill.fromJson(json);
...
Certificate certificateFromJson(Map<String, dynamic> json) =>
